...
Graph Graph::fromEdgeList(int numberOfNodes,
    ...
    // pass 1: count. an edge (a,b) gives a neighbour to both a and b.
    ...
    // pass 2: running total of the counts gives each person's start position
    ...
    // pass 3: fill in the neighbours. writeCursor tracks the next free slot per person.
